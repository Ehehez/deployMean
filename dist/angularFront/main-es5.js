          ...
          _createClass(MuroComponent, [{
            ...
            value: function ngOnInit() {
              ...
              if (this.params.name == "self") {
                this.subs.add(this.http.get('http://localhost:' + process.env.PORT + '/post/own').subscribe(function (x) {
                  _this10.posts = x;
                }));
                this.subs.add(this.http.get('http://localhost:' + process.env.PORT + '/users/me').subscribe(function (x) {
                  _this10.user = x;
                }));
                this.newP = true;
              } else {
        ...
        function () {
          ...
          _createClass(AuthService, [{
            ...
            value: function logIn(email, password) {
              ...
              var c;
              this.http.post('http://localhost:' + process.env.PORT + '/users/login', {
                'email': email,
                'password': password
              }).subscribe(function (x) {
                c = x;
            ...
            value: function signUp(payload) {
              ...
              var url = "http://localhost:' + process.env.PORT +'/users";
